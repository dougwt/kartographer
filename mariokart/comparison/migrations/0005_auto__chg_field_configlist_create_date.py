...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConfigList.create_date'
        db.alter_column(u'comparison_configlist', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'ConfigList.create_date'
        db.alter_column(u'comparison_configlist', 'create_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
